...
public class TimetableTodayAdmin extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timetable_today_admin);
    ...
    protected void onStart() {
        ...
        Call<List<Timetable>> getAdminTodayTimetable = API.getRetrofit().create(CallAPI.class).getTodayLecturesAdmin(jwtToken);
        System.out.println(jwtToken);

        getAdminTodayTimetable.enqueue(new Callback<List<Timetable>>() {
            @Override
            ...
            public void onFailure(Call<List<Timetable>> call, Throwable t) {
                Toast.makeText(TimetableTodayAdmin.this, "Loading Unsuccessful", Toast.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.AdminToday: {
                Intent intent = new Intent(TimetableTodayAdmin.this, TimetableTodayAdmin.class);
                startActivity(intent);
                Toast.makeText(getApplicationContext(), "Today's Lecture", Toast.LENGTH_LONG).show();
                break;
            }
            case R.id.AdminAll: {
                Intent intent = new Intent(TimetableTodayAdmin.this, TimetableAdmin.class);
                startActivity(intent);
