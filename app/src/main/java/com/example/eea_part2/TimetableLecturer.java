...
public class TimetableLecturer extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.NavMyModules:{
                        Intent intent = new Intent(TimetableLecturer.this, MyModulesLecturer.class);
                    ...
                    case R.id.Logout:{
                        ...
                        editor.apply();
                        finish();
                        Intent intent = new Intent(TimetableLecturer.this, MainActivity.class);
                        startActivity(intent);
    ...
    protected void onStart() {
        ...
        Call<List<Timetable>> getTimetableLecturer = API.getRetrofit().create(CallAPI.class).getAllLecturesLecturer(jwtToken);
        System.out.println(jwtToken);

        getTimetableLecturer.enqueue(new Callback<List<Timetable>>() {
            @Override
            public void onResponse(Call<List<Timetable>> call, Response<List<Timetable>> response) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(TimetableLecturer.this));

            }

            @Override
            public void onFailure(Call<List<Timetable>> call, Throwable t) {
                Toast.makeText(TimetableLecturer.this, "Loading Unsuccessful", Toast.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.StudentToday: {
                Intent intent = new Intent(TimetableLecturer.this, LecturerHome.class);
                startActivity(intent);
                Toast.makeText(getApplicationContext(), "Today's Lecture", Toast.LENGTH_LONG).show();
                break;
            }
            case R.id.StudentAll: {
                Intent intent = new Intent(TimetableLecturer.this, TimetableLecturer.class);
                startActivity(intent);
